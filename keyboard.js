	/**
 * There is a newer version: Virtual Keyboard Interface - v1.53
...
(function() {
  ...
  /* ***** i18n text strings ************************************* */
  this.VKI_turkish = {
	'00': "Sayı klavyesini göster",
	'01': "Sanal klavye arayüzünü göster",
	'02': "Klavye Düzeni Seç",
	'03': "Yaşamayan tuşlar",
	'04': "Açık",
	'05': "Kapalı",
	'06': "Klavyeyi Kapat",
	'07': "Sıfırla",
	'08': "Metin Kutusundakileri Sil",
	'09': "Sürüm",
	'10': "Klavyeyi küçült",
	'11': "Klavyeyi büyüt"
	};
  this.VKI_english = {
	'00': "Show numpad",
	'01': "Show virtual keyboard interface",
	'02': "Choose Keyboard Layout",
	'03': "Deadkeys",
	'04': "Open",
	'05': "Closed",
	'06': "Close Keyboard",
	'07': "Reset",
	'08': "Delete text in box",
	'09': "Version",
  ...
  this.VKI_layout['\u0627\u0644\u0639\u0631\u0628\u064a\u0629'] = {
    'name': "Arabic", 'keys': [
      ...
      [["Tab", "Tab"], ["\u0636", "\u064e", , "\u0661"], ["\u0635", "\u064b", , "\u0662"], ["\u062b", "\u064f", , "\u0663"], ["\u0642", "\u064c", , "\u0664"], ["\u0641", "\u0644", , "\u0665"], ["\u063a", "\u0625", , "\u0666"], ["\u0639", "\u2018", , "\u0667"], ["\u0647", "\u00f7", "\u06C0", "\u0668"], ["\u062e", "\u00d7", , "\u0669"], ["\u062d", "\u061b", , "\u0660"], ["\u062c", "<", "\u0686"], ["\u062f", ">"], ["\\", "|"]],
      [["Caps", "Caps"], ["\u0634", "\u0650"], ["\u0633", "\u064d"], ["\u064a", "]"], ["\u0628", "[", "\u067E"], ["\u0644", "\u0644"], ["\u0627", "\u0623"], ["\u062a", "\u0640"], ["\u0646", "\u060c", "\u06AF"], ["\u0645", "/"], ["\u0643", ":", "\u06AD"], ["\u0637", '"'], ["Enter", "Enter"]],
      [["Shift", "Shift"], ["\u0626", "~"], ["\u0621", "\u0652"], ["\u0624", "}"], ["\u0631", "{"], ["\u0644", "\u0644"], ["\u0649", "\u0622"], ["\u0629", "\u2019"], ["\u0648", ","], ["\u0632", ".", "\u0698"], ["\u0638", "\u061f"], ["Shift", "Shift"]],
      [[" ", " ", " ", " "], ["Alt", "Alt"]]
    ], 'lang': ["ar"] };

  this.VKI_layout['\u05e2\u05d1\u05e8\u05d9\u05ea'] = {
    'name': "İbranice desteklenen", 'keys': [
  ...
  this.VKI_layout['T\u00fcrk\u00e7e Q'] = {
    'name': "Türkçe Q desteklenebilir", 'keys': [
  ...
  this.VKI_layout['T\u00fcrk\u00e7e F'] = {
    'name': "Türkçe F desteklenebilir", 'keys': [
      [['+', "*", "\u00ac"], ["1", "!", "\u00b9", "\u00a1"], ["2", '"', "\u00b2"], ["3", "^", "#", "\u00b3"], ["4", "$", "\u00bc", "\u00a4"], ["5", "%", "\u00bd"], ["6", "&", "\u00be"], ["7", "'", "{"], ["8", "(", '['], ["9", ")", ']'], ["0", "=", "}"], ["/", "?", "\\", "\u00bf"], ["-", "_", "|"], ["Bksp", "Bksp"]],
  ...
  this.VKI_layout['US International'] = {
    'name': "İngilizce desteklenebilir", 'keys': [
      [["`", "~"], ["1", "!", "\u00a1", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a4", "\u00a3"], ["5", "%", "\u20ac"], ["6", "^", "\u00bc"], ["7", "&", "\u00bd"], ["8", "*", "\u00be"], ["9", "(", "\u2018"], ["0", ")", "\u2019"], ["-", "_", "\u00a5"], ["=", "+", "\u00d7", "\u00f7"], ["Bksp", "Bksp"]],
  ...
  VKI_attach = function(elem) {
    ...
    if (self.VKI_imageURI) {
      var keybut = document.createElement('img');
          ...
          if (VKI_getLanguage() == "turkish") {
			  keybut.alt = self.VKI_turkish['01'];
		  } else if (VKI_getLanguage() == "english") {
			  keybut.alt = self.VKI_english['01'];
		  }
          keybut.className = "keyboardInputInitiator";
          if (VKI_getLanguage() == "turkish") {
			  keybut.title = self.VKI_turkish['01'];
		  } else if (VKI_getLanguage() == "english") {
			  keybut.title = self.VKI_english['01'];
		  }
          keybut.elem = elem;
    ...
    if (self.VKI_isMoz)
      elem.addEventListener('blur', function() { this.setAttribute('scrollTop', this.scrollTop); }, false);
  };
  ...
  this.VKI_keyboard.style.animation = "bounceIn .6s";
    ...
    var tr = document.createElement('tr');
      var th = document.createElement('th');
        ...
        var kbSelect = document.createElement('div');
			if (VKI_getLanguage() == "turkish") {
			  kbSelect.title = this.VKI_turkish['02'];
		  } else if (VKI_getLanguage() == "english") {
			  kbSelect.title = this.VKI_english['02'];
		  }
        ...
        if (this.VKI_numberPad) {
          var span = document.createElement('span');
              ...
              if (VKI_getLanguage() == "turkish") {
			  span.title = this.VKI_turkish['00'];
			} else if (VKI_getLanguage() == "english") {
			  span.title = this.VKI_english['00'];
			}
        ...
        if (this.VKI_sizeAdj) {
          var small = document.createElement('small');
			if (VKI_getLanguage() == "turkish") {
			  small.title = this.VKI_turkish['10'];
			} else if (VKI_getLanguage() == "english") {
			  small.title = this.VKI_english['10'];
			}
          ...
          if (VKI_getLanguage() == "turkish") {
			  big.title = this.VKI_turkish['11'];
		} else if (VKI_getLanguage() == "english") {
			  big.title = this.VKI_english['11'];
		}
        ...
        var span = document.createElement('span');
			if (VKI_getLanguage() == "turkish") {
			  span.appendChild(document.createTextNode(this.VKI_turkish['07']));
			  span.title = this.VKI_turkish['08'];
			} else if (VKI_getLanguage() == "english") {
			  span.appendChild(document.createTextNode(this.VKI_english['07']));
			  span.title = this.VKI_english['08'];
			}
          VKI_addListener(span, 'click', function() {
        ...
        var strong = document.createElement('strong');
            ...
            if (VKI_getLanguage() == "turkish") {
			  strong.title = this.VKI_turkish['06'];
			} else if (VKI_getLanguage() == "english") {
			  strong.title = this.VKI_english['06'];
			}
      ...
      var td = document.createElement('td');
        ...
        if (this.VKI_deadBox) {
          var label = document.createElement('label');
            var checkbox = document.createElement('input');
                ...
                if (VKI_getLanguage() == "turkish") {
				checkbox.title = this.VKI_turkish['03'] + ": " + ((this.VKI_deadkeysOn) ? this.VKI_turkish['04'] : this.VKI_turkish['05']);
				} else if (VKI_getLanguage() == "english") {
				checkbox.title = this.VKI_english['03'] + ": " + ((this.VKI_deadkeysOn) ? this.VKI_english['04'] : this.VKI_english['05']);
				}
                checkbox.defaultChecked = this.VKI_deadkeysOn;
              VKI_addListener(checkbox, 'click', function() {
                if (VKI_getLanguage() == "turkish") {
				this.title = self.VKI_turkish['03'] + ": " + ((this.checked) ? self.VKI_turkish['04'] : self.VKI_turkish['05']);
				} else if (VKI_getLanguage() == "english") {
				this.title = self.VKI_english['03'] + ": " + ((this.checked) ? self.VKI_english['04'] : self.VKI_english['05']);
				}
                self.VKI_modify("");
                return true;
              }, false);
        ...
        if (this.VKI_showVersion) {
          var vr = document.createElement('var');
			  if (VKI_getLanguage() == "turkish") {
				vr.title = this.VKI_turkish['09'] + " " + this.VKI_version;
			} else if (VKI_getLanguage() == "english") {
				vr.title = this.VKI_english['09'] + " " + this.VKI_version;
			}
  ...
  function VKI_getLanguage() {
	var abjadlanguageelem = document.getElementById("abjadlanguage");
	var languagevalue = abjadlanguageelem.value;
		if (abjadlanguageelem !== null || abjadlanguageelem !== undefined) {
